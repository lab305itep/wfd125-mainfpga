...
##Load Design
vsim -t 1ps -L SECUREIP -L SIMPRIMS_VER -sdftyp /DEMO_TB_IMP/gtp_top_i=../../implement/results/routed.sdf +no_notifier +notimingchecks work.DEMO_TB_IMP work.glbl -voptargs="+acc"
