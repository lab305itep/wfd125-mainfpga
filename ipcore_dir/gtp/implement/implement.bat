...
COPY gtp_top.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\gtp_top.ucf -p xc6slx45t-fgg484-2 gtp_top.ngc gtp_top.ngd
...
ECHO 'Running NGD'
map -register_duplication on -global_opt speed -logic_opt on -retiming on -timing -ol high -p xc6slx45t-fgg484-2 -o mapped.ncd gtp_top.ngd
