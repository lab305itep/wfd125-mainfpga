...
COPY gtp_top.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\gtp_top.ucf -p xc6slx45t-fgg484-2 gtp_top.edf gtp_top.ngd
...
ECHO 'Running NGD'
map -register_duplication on -global_opt speed -logic_opt on -retiming on -timing -ol high -w -p xc6slx45t-fgg484-2 -o mapped.ncd gtp_top.ngd
...
netgen -ofmt verilog -sim -sdf_path ../../implement/results -dir . -tm gtp_top -w routed.ncd routed.v
