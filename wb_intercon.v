...
module wb_intercon
   (input         wb_clk_i,
    ...
    input         wb_fifoD_stall_i,
    input         wb_fifoD_rty_i);

wb_mux
  #(.num_slaves (16),
    .MATCH_ADDR ({32'h00000000, 32'h20000000, 32'h20000008, 32'h20000010, 32'h20000020, 32'h20000030, 32'h20000038, 32'h20000040, 32'h20000100, 32'h20000108, 32'h20000110, 32'h20000118, 32'h20004000, 32'h20006000, 32'h20008000, 32'h2000a000}),
    .MATCH_MASK ({32'he0000000, 32'hfffffff8, 32'hfffffff8, 32'hfffffff0, 32'hfffffff0, 32'hfffffff8, 32'hfffffff8, 32'hffffffe0, 32'hfffffff8, 32'hfffffff8, 32'hfffffff8, 32'hfffffff8, 32'hffffe000, 32'hffffe000, 32'hffffe000, 32'hffffe000}))
 wb_mux_VME64xCore_Top
   (.wb_clk_i    (wb_clk_i),
    ...
    .wbs_adr_o   ({wb_sdram_adr_o, wb_reg_csr_adr_o, wb_reg_ver_adr_o, wb_triggen_adr_o, wb_reg_fifo_adr_o, wb_icx_spi_adr_o, wb_dac_spi_adr_o, wb_i2c_ms_cbuf_adr_o, wb_regA_adr_o, wb_regB_adr_o, wb_regC_adr_o, wb_regD_adr_o, wb_fifoA_adr_o, wb_fifoB_adr_o, wb_fifoC_adr_o, wb_fifoD_adr_o}),
    .wbs_dat_o   ({wb_sdram_dat_o, wb_reg_csr_dat_o, wb_reg_ver_dat_o, wb_triggen_dat_o, wb_reg_fifo_dat_o, wb_icx_spi_dat_o, wb_dac_spi_dat_o, wb_i2c_ms_cbuf_dat_o, wb_regA_dat_o, wb_regB_dat_o, wb_regC_dat_o, wb_regD_dat_o, wb_fifoA_dat_o, wb_fifoB_dat_o, wb_fifoC_dat_o, wb_fifoD_dat_o}),
    .wbs_sel_o   ({wb_sdram_sel_o, wb_reg_csr_sel_o, wb_reg_ver_sel_o, wb_triggen_sel_o, wb_reg_fifo_sel_o, wb_icx_spi_sel_o, wb_dac_spi_sel_o, wb_i2c_ms_cbuf_sel_o, wb_regA_sel_o, wb_regB_sel_o, wb_regC_sel_o, wb_regD_sel_o, wb_fifoA_sel_o, wb_fifoB_sel_o, wb_fifoC_sel_o, wb_fifoD_sel_o}),
    .wbs_we_o    ({wb_sdram_we_o, wb_reg_csr_we_o, wb_reg_ver_we_o, wb_triggen_we_o, wb_reg_fifo_we_o, wb_icx_spi_we_o, wb_dac_spi_we_o, wb_i2c_ms_cbuf_we_o, wb_regA_we_o, wb_regB_we_o, wb_regC_we_o, wb_regD_we_o, wb_fifoA_we_o, wb_fifoB_we_o, wb_fifoC_we_o, wb_fifoD_we_o}),
    .wbs_cyc_o   ({wb_sdram_cyc_o, wb_reg_csr_cyc_o, wb_reg_ver_cyc_o, wb_triggen_cyc_o, wb_reg_fifo_cyc_o, wb_icx_spi_cyc_o, wb_dac_spi_cyc_o, wb_i2c_ms_cbuf_cyc_o, wb_regA_cyc_o, wb_regB_cyc_o, wb_regC_cyc_o, wb_regD_cyc_o, wb_fifoA_cyc_o, wb_fifoB_cyc_o, wb_fifoC_cyc_o, wb_fifoD_cyc_o}),
    .wbs_stb_o   ({wb_sdram_stb_o, wb_reg_csr_stb_o, wb_reg_ver_stb_o, wb_triggen_stb_o, wb_reg_fifo_stb_o, wb_icx_spi_stb_o, wb_dac_spi_stb_o, wb_i2c_ms_cbuf_stb_o, wb_regA_stb_o, wb_regB_stb_o, wb_regC_stb_o, wb_regD_stb_o, wb_fifoA_stb_o, wb_fifoB_stb_o, wb_fifoC_stb_o, wb_fifoD_stb_o}),
    .wbs_cti_o   ({wb_sdram_cti_o, wb_reg_csr_cti_o, wb_reg_ver_cti_o, wb_triggen_cti_o, wb_reg_fifo_cti_o, wb_icx_spi_cti_o, wb_dac_spi_cti_o, wb_i2c_ms_cbuf_cti_o, wb_regA_cti_o, wb_regB_cti_o, wb_regC_cti_o, wb_regD_cti_o, wb_fifoA_cti_o, wb_fifoB_cti_o, wb_fifoC_cti_o, wb_fifoD_cti_o}),
    .wbs_bte_o   ({wb_sdram_bte_o, wb_reg_csr_bte_o, wb_reg_ver_bte_o, wb_triggen_bte_o, wb_reg_fifo_bte_o, wb_icx_spi_bte_o, wb_dac_spi_bte_o, wb_i2c_ms_cbuf_bte_o, wb_regA_bte_o, wb_regB_bte_o, wb_regC_bte_o, wb_regD_bte_o, wb_fifoA_bte_o, wb_fifoB_bte_o, wb_fifoC_bte_o, wb_fifoD_bte_o}),
    .wbs_dat_i   ({wb_sdram_dat_i, wb_reg_csr_dat_i, wb_reg_ver_dat_i, wb_triggen_dat_i, wb_reg_fifo_dat_i, wb_icx_spi_dat_i, wb_dac_spi_dat_i, wb_i2c_ms_cbuf_dat_i, wb_regA_dat_i, wb_regB_dat_i, wb_regC_dat_i, wb_regD_dat_i, wb_fifoA_dat_i, wb_fifoB_dat_i, wb_fifoC_dat_i, wb_fifoD_dat_i}),
    .wbs_ack_i   ({wb_sdram_ack_i, wb_reg_csr_ack_i, wb_reg_ver_ack_i, wb_triggen_ack_i, wb_reg_fifo_ack_i, wb_icx_spi_ack_i, wb_dac_spi_ack_i, wb_i2c_ms_cbuf_ack_i, wb_regA_ack_i, wb_regB_ack_i, wb_regC_ack_i, wb_regD_ack_i, wb_fifoA_ack_i, wb_fifoB_ack_i, wb_fifoC_ack_i, wb_fifoD_ack_i}),
    .wbs_err_i   ({wb_sdram_err_i, wb_reg_csr_err_i, wb_reg_ver_err_i, wb_triggen_err_i, wb_reg_fifo_err_i, wb_icx_spi_err_i, wb_dac_spi_err_i, wb_i2c_ms_cbuf_err_i, wb_regA_err_i, wb_regB_err_i, wb_regC_err_i, wb_regD_err_i, wb_fifoA_err_i, wb_fifoB_err_i, wb_fifoC_err_i, wb_fifoD_err_i}),
    .wbs_stall_i ({wb_sdram_stall_i, wb_reg_csr_stall_i, wb_reg_ver_stall_i, wb_triggen_stall_i, wb_reg_fifo_stall_i, wb_icx_spi_stall_i, wb_dac_spi_stall_i, wb_i2c_ms_cbuf_stall_i, wb_regA_stall_i, wb_regB_stall_i, wb_regC_stall_i, wb_regD_stall_i, wb_fifoA_stall_i, wb_fifoB_stall_i, wb_fifoC_stall_i, wb_fifoD_stall_i}),
    .wbs_rty_i   ({wb_sdram_rty_i, wb_reg_csr_rty_i, wb_reg_ver_rty_i, wb_triggen_rty_i, wb_reg_fifo_rty_i, wb_icx_spi_rty_i, wb_dac_spi_rty_i, wb_i2c_ms_cbuf_rty_i, wb_regA_rty_i, wb_regB_rty_i, wb_regC_rty_i, wb_regD_rty_i, wb_fifoA_rty_i, wb_fifoB_rty_i, wb_fifoC_rty_i, wb_fifoD_rty_i}));
