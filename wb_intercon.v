...
wb_mux
  #(.num_slaves (6),
    .MATCH_ADDR ({32'h00010000, 32'h00020000, 32'h00040000, 32'h00060000, 32'h00080000, 32'h000a0000}),
    .MATCH_MASK ({32'hfffff000, 32'hfffff000, 32'hffffe000, 32'hffffe000, 32'hffffe000, 32'hffffe000}))
 wb_mux_VME64xCore_Top
   (.wb_clk_i  (wb_clk_i),
    ...
    .wbs_adr_o ({wb_simple_gpio_adr_o, wb_m2s_resize_i2c_ms_cbuf_adr, wb_mymemA_adr_o, wb_mymemB_adr_o, wb_mymemC_adr_o, wb_mymemD_adr_o}),
    .wbs_dat_o ({wb_simple_gpio_dat_o, wb_m2s_resize_i2c_ms_cbuf_dat, wb_mymemA_dat_o, wb_mymemB_dat_o, wb_mymemC_dat_o, wb_mymemD_dat_o}),
    .wbs_sel_o ({wb_simple_gpio_sel_o, wb_m2s_resize_i2c_ms_cbuf_sel, wb_mymemA_sel_o, wb_mymemB_sel_o, wb_mymemC_sel_o, wb_mymemD_sel_o}),
    .wbs_we_o  ({wb_simple_gpio_we_o, wb_m2s_resize_i2c_ms_cbuf_we, wb_mymemA_we_o, wb_mymemB_we_o, wb_mymemC_we_o, wb_mymemD_we_o}),
    .wbs_cyc_o ({wb_simple_gpio_cyc_o, wb_m2s_resize_i2c_ms_cbuf_cyc, wb_mymemA_cyc_o, wb_mymemB_cyc_o, wb_mymemC_cyc_o, wb_mymemD_cyc_o}),
    .wbs_stb_o ({wb_simple_gpio_stb_o, wb_m2s_resize_i2c_ms_cbuf_stb, wb_mymemA_stb_o, wb_mymemB_stb_o, wb_mymemC_stb_o, wb_mymemD_stb_o}),
    .wbs_cti_o ({wb_simple_gpio_cti_o, wb_m2s_resize_i2c_ms_cbuf_cti, wb_mymemA_cti_o, wb_mymemB_cti_o, wb_mymemC_cti_o, wb_mymemD_cti_o}),
    .wbs_bte_o ({wb_simple_gpio_bte_o, wb_m2s_resize_i2c_ms_cbuf_bte, wb_mymemA_bte_o, wb_mymemB_bte_o, wb_mymemC_bte_o, wb_mymemD_bte_o}),
    .wbs_dat_i ({wb_simple_gpio_dat_i, wb_s2m_resize_i2c_ms_cbuf_dat, wb_mymemA_dat_i, wb_mymemB_dat_i, wb_mymemC_dat_i, wb_mymemD_dat_i}),
    .wbs_ack_i ({wb_simple_gpio_ack_i, wb_s2m_resize_i2c_ms_cbuf_ack, wb_mymemA_ack_i, wb_mymemB_ack_i, wb_mymemC_ack_i, wb_mymemD_ack_i}),
    .wbs_err_i ({wb_simple_gpio_err_i, wb_s2m_resize_i2c_ms_cbuf_err, wb_mymemA_err_i, wb_mymemB_err_i, wb_mymemC_err_i, wb_mymemD_err_i}),
    .wbs_rty_i ({wb_simple_gpio_rty_i, wb_s2m_resize_i2c_ms_cbuf_rty, wb_mymemA_rty_i, wb_mymemB_rty_i, wb_mymemC_rty_i, wb_mymemD_rty_i}));
