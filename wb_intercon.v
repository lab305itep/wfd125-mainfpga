...
module wb_intercon
   (input         wb_clk_i,
    ...
    output [31:0] wb_ethctl_adr_o,
    output [31:0] wb_ethctl_dat_o,
    output  [3:0] wb_ethctl_sel_o,
    output        wb_ethctl_we_o,
    output        wb_ethctl_cyc_o,
    output        wb_ethctl_stb_o,
    output  [2:0] wb_ethctl_cti_o,
    output  [1:0] wb_ethctl_bte_o,
    input  [31:0] wb_ethctl_dat_i,
    input         wb_ethctl_ack_i,
    input         wb_ethctl_err_i,
    input         wb_ethctl_stall_i,
    input         wb_ethctl_rty_i,
    output [31:0] wb_sdrama32_adr_o,
    output [31:0] wb_sdrama32_dat_o,
    output  [3:0] wb_sdrama32_sel_o,
    output        wb_sdrama32_we_o,
    output        wb_sdrama32_cyc_o,
    output        wb_sdrama32_stb_o,
    output  [2:0] wb_sdrama32_cti_o,
    output  [1:0] wb_sdrama32_bte_o,
    input  [31:0] wb_sdrama32_dat_i,
    input         wb_sdrama32_ack_i,
    input         wb_sdrama32_err_i,
    input         wb_sdrama32_stall_i,
    input         wb_sdrama32_rty_i);

wb_mux
  #(.num_slaves (10),
    .MATCH_ADDR ({32'h00000000, 32'h20000000, 32'h20000008, 32'h20000010, 32'h20000020, 32'h20000030, 32'h20000038, 32'h20000040, 32'h20008000, 32'h20000060}),
    .MATCH_MASK ({32'he0000000, 32'hfffffff8, 32'hfffffff8, 32'hfffffff0, 32'hfffffff0, 32'hfffffff8, 32'hfffffff8, 32'hffffffe0, 32'hffff8000, 32'hfffffff0}))
 wb_mux_VME64xCore_Top
   (.wb_clk_i    (wb_clk_i),
    ...
    .wbs_adr_o   ({wb_sdram_adr_o, wb_reg_csr_adr_o, wb_reg_ver_adr_o, wb_triggen_adr_o, wb_reg_fifo_adr_o, wb_icx_spi_adr_o, wb_dac_spi_adr_o, wb_i2c_ms_cbuf_adr_o, wb_sdrama32_adr_o, wb_ethctl_adr_o}),
    .wbs_dat_o   ({wb_sdram_dat_o, wb_reg_csr_dat_o, wb_reg_ver_dat_o, wb_triggen_dat_o, wb_reg_fifo_dat_o, wb_icx_spi_dat_o, wb_dac_spi_dat_o, wb_i2c_ms_cbuf_dat_o, wb_sdrama32_dat_o, wb_ethctl_dat_o}),
    .wbs_sel_o   ({wb_sdram_sel_o, wb_reg_csr_sel_o, wb_reg_ver_sel_o, wb_triggen_sel_o, wb_reg_fifo_sel_o, wb_icx_spi_sel_o, wb_dac_spi_sel_o, wb_i2c_ms_cbuf_sel_o, wb_sdrama32_sel_o, wb_ethctl_sel_o}),
    .wbs_we_o    ({wb_sdram_we_o, wb_reg_csr_we_o, wb_reg_ver_we_o, wb_triggen_we_o, wb_reg_fifo_we_o, wb_icx_spi_we_o, wb_dac_spi_we_o, wb_i2c_ms_cbuf_we_o, wb_sdrama32_we_o, wb_ethctl_we_o}),
    .wbs_cyc_o   ({wb_sdram_cyc_o, wb_reg_csr_cyc_o, wb_reg_ver_cyc_o, wb_triggen_cyc_o, wb_reg_fifo_cyc_o, wb_icx_spi_cyc_o, wb_dac_spi_cyc_o, wb_i2c_ms_cbuf_cyc_o, wb_sdrama32_cyc_o, wb_ethctl_cyc_o}),
    .wbs_stb_o   ({wb_sdram_stb_o, wb_reg_csr_stb_o, wb_reg_ver_stb_o, wb_triggen_stb_o, wb_reg_fifo_stb_o, wb_icx_spi_stb_o, wb_dac_spi_stb_o, wb_i2c_ms_cbuf_stb_o, wb_sdrama32_stb_o, wb_ethctl_stb_o}),
    .wbs_cti_o   ({wb_sdram_cti_o, wb_reg_csr_cti_o, wb_reg_ver_cti_o, wb_triggen_cti_o, wb_reg_fifo_cti_o, wb_icx_spi_cti_o, wb_dac_spi_cti_o, wb_i2c_ms_cbuf_cti_o, wb_sdrama32_cti_o, wb_ethctl_cti_o}),
    .wbs_bte_o   ({wb_sdram_bte_o, wb_reg_csr_bte_o, wb_reg_ver_bte_o, wb_triggen_bte_o, wb_reg_fifo_bte_o, wb_icx_spi_bte_o, wb_dac_spi_bte_o, wb_i2c_ms_cbuf_bte_o, wb_sdrama32_bte_o, wb_ethctl_bte_o}),
    .wbs_dat_i   ({wb_sdram_dat_i, wb_reg_csr_dat_i, wb_reg_ver_dat_i, wb_triggen_dat_i, wb_reg_fifo_dat_i, wb_icx_spi_dat_i, wb_dac_spi_dat_i, wb_i2c_ms_cbuf_dat_i, wb_sdrama32_dat_i, wb_ethctl_dat_i}),
    .wbs_ack_i   ({wb_sdram_ack_i, wb_reg_csr_ack_i, wb_reg_ver_ack_i, wb_triggen_ack_i, wb_reg_fifo_ack_i, wb_icx_spi_ack_i, wb_dac_spi_ack_i, wb_i2c_ms_cbuf_ack_i, wb_sdrama32_ack_i, wb_ethctl_ack_i}),
    .wbs_err_i   ({wb_sdram_err_i, wb_reg_csr_err_i, wb_reg_ver_err_i, wb_triggen_err_i, wb_reg_fifo_err_i, wb_icx_spi_err_i, wb_dac_spi_err_i, wb_i2c_ms_cbuf_err_i, wb_sdrama32_err_i, wb_ethctl_err_i}),
    .wbs_stall_i ({wb_sdram_stall_i, wb_reg_csr_stall_i, wb_reg_ver_stall_i, wb_triggen_stall_i, wb_reg_fifo_stall_i, wb_icx_spi_stall_i, wb_dac_spi_stall_i, wb_i2c_ms_cbuf_stall_i, wb_sdrama32_stall_i, wb_ethctl_stall_i}),
    .wbs_rty_i   ({wb_sdram_rty_i, wb_reg_csr_rty_i, wb_reg_ver_rty_i, wb_triggen_rty_i, wb_reg_fifo_rty_i, wb_icx_spi_rty_i, wb_dac_spi_rty_i, wb_i2c_ms_cbuf_rty_i, wb_sdrama32_rty_i, wb_ethctl_rty_i}));
